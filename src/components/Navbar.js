            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-16">
                    ...
                    <div className="hidden md:flex items-center">
                        <a
                            href={`https://wa.me/6282120369004?text=${encodeURIComponent("Halo PT. PONCO MUNARO UTAMA, saya tertarik untuk berkonsultasi mengenai layanan [Konstruksi/Sumur Bor/Listrik]. Mohon informasi lebih lanjut mengenai prosedur dan estimasi biayanya. Terima kasih.")}`}
                            target="_blank"
